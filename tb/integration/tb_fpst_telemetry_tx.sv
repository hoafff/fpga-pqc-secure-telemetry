...
module tb_fpst_telemetry_tx;
    ...
    logic ready,busy,done,packet_valid,err_v,packet_release;
    ...
    fpst_telemetry_tx dut(
        ...
        .packet_release_i(packet_release),.error_valid_o(err_v),.error_code_o(err));
    ...
    initial begin
        sample='0; packet_release=0; packet_addr=0;
        ...
        packet_release=1; @(posedge clk); @(negedge clk); packet_release=0;
