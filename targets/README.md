...
| [`tiny1p5`](tiny1p5/README.md) | Kiwi FPGA Tiny 1P5 | Supervisor/watchdog/tamper | Chưa triển khai RTL target trên `main` |
| [`sn32f407`](sn32f407/README.md) | SONiX SN32F407 EVK | Firmware control và PC–FPGA bridge | SONiX port + UART/SPI firmware đã implement; external harness/Primer link còn chờ hardware verification |
| [`pc`](pc/README.md) | Máy tính | Host, golden model, simulation, benchmark | Python host deployment candidate đã có cho SN32 CLI; full session/STP telemetry còn phụ thuộc endpoint commands |
