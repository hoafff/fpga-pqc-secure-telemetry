...
| SN32F407F | Primer #1 | Primer #2 | Chức năng |
|---|---|---|---|
| `P1.0` | `J2-3 / FPGA P16` | `J2-3 / FPGA P16` | `SPI0_SCK` |
| `P1.2` | `J2-5 / FPGA P15` | `J2-5 / FPGA P15` | `SPI0_MOSI` |
| `P1.1` | `J2-7 / FPGA T15` | `J2-7 / FPGA T15` | `SPI0_MISO` |
...
| SN32F407F | Đích | Chức năng |
|---|---|---|
| `P2.1` | Primer #1 `J2-8 / R14` | `CS1_N` |
| `P2.3` | Primer #1 `J2-10 / T14` | `IRQ1_N` |
| `P2.2` | Primer #2 `J2-8 / R14` | `CS2_N` |
| `P2.8` | Primer #2 `J2-10 / T14` | `IRQ2_N` |
...
| Tiny J1 | FPGA pin | Signal | Polarity / use |
|---:|---:|---|---|
| 1 | 2 | `HB_MCU` | heartbeat toggle input |
| 2 | 3 | `HB_PQC` | heartbeat Primer #1 |
| 3 | 5 | `HB_CRYPTO` | heartbeat Primer #2 |
...
| 8 | 11 | `ZEROIZE_N` | **active-low physical output** |
...
| J2 | FPGA pin | Signal | Nối tới |
|---:|---|---|---|
| 3 | P16 | `SPI_SCK` | SN32 `P1.0` |
| 5 | P15 | `SPI_MOSI` | SN32 `P1.2` |
| 7 | T15 | `SPI_MISO` | SN32 `P1.1` shared |
| 8 | R14 | `SPI_CS_N` | P1: SN32 `P2.1`; P2: SN32 `P2.2` |
| 10 | T14 | `IRQ_N` | P1: SN32 `P2.3`; P2: SN32 `P2.8` |
| 11 | R13 | `BUSY` | currently not required by SN32 dual-Primer link |
| 12 | T13 | `FAULT` | currently diagnostic / not wired into current supervisor harness |
| 13 | R12 | `FATAL_LATCHED` | Tiny `J1-10` |
| 15 | T12 | `SECURE_ENABLE` | Tiny `J1-7` |
| 16 | R11 | `ZEROIZE_N` | Tiny `J1-8` |
| 18 | T11 | `HEARTBEAT` | P1→Tiny `J1-2`; P2→Tiny `J1-3` |
